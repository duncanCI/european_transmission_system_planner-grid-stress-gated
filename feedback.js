...
(function () {
  ...
  var CSS = [
    ...
    "  font:13px/1.45 Roboto,system-ui,-apple-system,'Segoe UI',sans-serif;color:#231A45}",
    ...
    "#fb .fbrow button.fbprimary{background:#29194F;color:#fff;border-color:#29194F}",
    "#fb .fbrow button.fbprimary:hover{background:#330084}",
    "a.fbflag,a.fbasm{color:#3E0CBA;cursor:pointer;font-size:11px}",
